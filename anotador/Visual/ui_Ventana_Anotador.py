...
################################################################################
## Form generated from reading UI file 'Ventana_AnotadorWyiNbj.ui'
##
...
class Ui_MainWindowAnotador(object):
    def setupUi(self, MainWindowAnotador):
        if not MainWindowAnotador.objectName():
            MainWindowAnotador.setObjectName(u"MainWindowAnotador")
        MainWindowAnotador.resize(800, 680)
        MainWindowAnotador.setAutoFillBackground(False)
        MainWindowAnotador.setStyleSheet(u"")
        self.centralwidget = QWidget(MainWindowAnotador)
...
"background-color: rgb(254, 255, 237);")
        ...
        MainWindowAnotador.setCentralWidget(self.centralwidget)

        self.retranslateUi(MainWindowAnotador)

        QMetaObject.connectSlotsByName(MainWindowAnotador)
    # setupUi

    def retranslateUi(self, MainWindowAnotador):
        MainWindowAnotador.setWindowTitle(QCoreApplication.translate("MainWindowAnotador", u"Anotador", None))
        self.labelLibros.setText(QCoreApplication.translate("MainWindowAnotador", u"Lista de Libros", None))
        self.pushButtonCrear_Libro.setText(QCoreApplication.translate("MainWindowAnotador", u"Crear nuevo libro", None))
        self.pushButton_Ver_Libro.setText(QCoreApplication.translate("MainWindowAnotador", u"Ver libro", None))
        self.pushButton_Modificar_Libro.setText(QCoreApplication.translate("MainWindowAnotador", u"Modificar libro", None))
        self.pushButton_Archivar_Libro.setText(QCoreApplication.translate("MainWindowAnotador", u"Archivar libro", None))
        self.pushButton_Borrar_Libro.setText(QCoreApplication.translate("MainWindowAnotador", u"Borrar libro", None))
        self.pushButton_Informe_Etiqueta.setText(QCoreApplication.translate("MainWindowAnotador", u"Informe etiqueta", None))
        self.pushButton_Buscar_Nota.setText(QCoreApplication.translate("MainWindowAnotador", u"Buscar nota", None))
        self.pushButton_Notas_Destacadas.setText(QCoreApplication.translate("MainWindowAnotador", u"Notas destacadas", None))
    # retranslateUi
